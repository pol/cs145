...
describe "Lab3 Project" do
  ...
  before(:all) do
    @doc = open("lab3/index.html") { |f| Hpricot(f) }
  end
  ...
  describe "header 1 text" do
    it "should be san-serif text"
    it "should be 50 pixels high"
    it "should have a background color of rgb(255,255,150)"
  ...
  describe "header 2 text" do
    it "should appear as serif text"
    it "should be 25 pixels high"
    it "should have a background color of #0000ff"
    it "should be italicized"
    it "should be small-caps font variant"
    it "should have a 5 pixel spacing between each character"
  end
  ...
  describe "the background image" do
    it "should exist as images/pattern_096.gif"
    it "should be repeated (tiled)"
  end
